        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <h1 class="page-header">
                    <?php
                    $posted_by = $_GET['user'];
                    $first = strtoupper(substr($posted_by, 0, 1));
                    $num = 0 - (strlen($posted_by) - 1);
                    $second = strtolower(substr($posted_by,$num));
                    echo $first . $second;
                     ?>
                    <small>Programmer by love</small>
                </h1>
                ...
                <?php
                  ...
                  $sql = mysql_query("SELECT * FROM posts WHERE posted_by='$posted_by'");
